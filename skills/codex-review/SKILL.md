...
If the user passed arguments (e.g., `/codex-review gpt-5.5`), parse the model name and use it instead of the default.
...
**CLI notes:**
- Default model: `gpt-5.5` (thorough, good balance of quality and speed).
...
```
## Codex Review — Round N [Plan/Code] (gpt-5.5)
...
### If approved:
```
## Codex Review — Final [Plan/Code] (gpt-5.5)
...
- Default model: `gpt-5.5`. User can override via arguments (e.g., `/codex-review gpt-5.3-codex`)
