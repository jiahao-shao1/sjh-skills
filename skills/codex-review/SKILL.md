...
**CLI notes:**
- Default model: `gpt-5.4` (thorough, good balance of quality and speed).
...
```
## Codex Review — Round N [Plan/Code] (gpt-5.4)
...
### If approved:
```
## Codex Review — Final [Plan/Code] (gpt-5.4)
...
- Default model: `gpt-5.4`. User can override via arguments (e.g., `/codex-review gpt-5.3-codex`)
