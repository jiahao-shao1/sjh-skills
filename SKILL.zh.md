...
3. 如果仍找不到，提醒用户按 [references/setup.zh.md](./references/setup.zh.md) 配置
...
- **有 Notion MCP 工具**（如 Claude Code / Claude.ai）→ 见 [references/mcp-guide.zh.md](./references/mcp-guide.zh.md)
- **有 Notion API 访问**（如 OpenClaw / Codex / 其他 Agent）→ 见 [references/api-guide.zh.md](./references/api-guide.zh.md)
